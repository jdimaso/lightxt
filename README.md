...
- View-mode Markdown export to paginated PDF, plus native printing for Markdown and plain-text documents through the same complete-document PDF pipeline
